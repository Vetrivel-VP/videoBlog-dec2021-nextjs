function MenuContainer({ icon, menuName }) {
  return (
    <div
      className="group flex items-center sm:px-3 sm:py-2 lg:py-3 lg:px-6 cursor-pointer relative
    ...
    >
      ...
      <p className="text-[14px] text-textColor ml-4  group-hover:text-primary">
        {menuName}
      </p>
    </div>
  );
